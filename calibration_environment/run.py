...
def time_duration_has_passed(duration, timestamp) -> bool:
    """Checks whether the given duration in seconds has passed since the given timestamp.
    """
    datetime_delta = datetime.now() - timestamp

    return datetime_delta.total_seconds() > duration
