...
def run(cli_args):
    ...
    while True:
        for setpoint in calibration_configuration["setpoints"]:
            water_bath_com_port = calibration_configuration["com_port_args"][
                "water_bath"
            ]
            ...
            o2_set_point_fraction = gas_mixer.get_o2_target_fraction(
            ...
            gas_mixer.start_constant_flow_mix(
                gas_mixer_com_port, setpoint["flow_rate_slpm"], o2_set_point_fraction
            )
                ...
                row = pd.Series(
                    {
                        ...
                        "o2_source_gas_fraction": calibration_configuration[
